    ...
    public override void PlaySound()
    {
        ...
        if (hit.Length > 0)
        {
            ...
            if ((1 << hit[0].collider.gameObject.layer) == ((1 << hit[0].collider.gameObject.layer) & _stateMachine.Character.AnimationData.StoneLayer))
            {
                ...
                SoundManager.Instance.Play(_stateMachine.Character.AnimationData.StepOnStone[Random.Range(0, _stateMachine.Character.AnimationData.StepOnStone.Count-1)], eSoundType.Effect,
            ...
            {
                SoundManager.Instance.Play(_stateMachine.Character.AnimationData.StepOnGrass[Random.Range(0, _stateMachine.Character.AnimationData.StepOnGrass.Count-1)], eSoundType.Effect,
                    1.0f, Mathf.Clamp(1 / distance, 0.0f, 1.0f));
            }
        }
    }
